...
/**
 * In this example, if the promise resolves successfully, 
 * the function inside .then() will be executed. If an error occurs during the promise 
 * execution, the function inside .catch() will be executed.
 */
...
the control flow will skip to the nearest .catch() block:*/
...
/**
 * By following these principles, you can create robust and maintainable asynchronous 
 * code with promises,ensuring that errors are handled appropriately at each step of the execution.
 */